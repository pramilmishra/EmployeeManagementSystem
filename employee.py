...
class Employee:
    ...
    #    Variable
       ...
       Main_frame.place(x=10,y=220,width=1500,height=560)
        ...
        # upper frame
       Upper_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,text='Employee Inforrmation',font=('times new roman', 11,'bold'),fg='darkblue',bg='white')
       ...
       com_txt_proof['value'] = ('Select ID Proof','PAN CARD','ADHAR CARD','DRIVING LISCENCE','VOTER CARD')
       ...
       btn_add=Button(Button_frame,text = "Save",command=self.add_data, font=('arial',15,'bold'),width=13,bg='darkblue',fg='white')
       btn_add.grid(row=0,column=0,padx=1,pady=5)

       btn_update=Button(Button_frame,text = "Update",command=self.update_data, font=('arial',15,'bold'),width=13,bg='darkblue',fg='white')
       btn_update.grid(row=1,column=0,padx=1,pady=5)

       btn_delete=Button(Button_frame,text = "Delete",command=self.delete_data, font=('arial',15,'bold'),width=13,bg='darkblue',fg='white')
       btn_delete.grid(row=3,column=0,padx=1,pady=5)

       btn_clear=Button(Button_frame,text = "Clear",command=self.reset_data, font=('arial',15,'bold'),width=13,bg='darkblue',fg='white')
       btn_clear.grid(row=4,column=0,padx=1,pady=5)
        ...
        # lower frame
       down_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,text='Employee Inforrmation Table',font=('times new roman', 11,'bold'),fg='darkblue',bg='white')
       down_frame.place(x=10,y=280,width=1480,height=270)

       # search frame
       search_frame=LabelFrame(down_frame,bd=2,relief=RIDGE,text='Search Employee Information',font=('times new roman', 11,'bold'),fg='darkblue',bg='white')
       search_frame.place(x=0,y=0,width=1470,height=60)

       search_by=Label(search_frame,font=('arial', 11,'bold'),text='Search by:',fg='white', bg='darkblue') 
       ...
       com_txt_search['value'] = ("Select Option","id_proof")
       ...
       btn_search=Button(search_frame,command=self.search_data,text = "Search", font=('arial',11,'bold'),width=14,bg='darkblue',fg='white')
       btn_search.grid(row=0,column=3,padx=5)

       btn_ShowAll=Button(search_frame,text = "Show All",command=self.fetch_data, font=('arial',11,'bold'),width=14,bg='darkblue',fg='white')
       btn_ShowAll.grid(row=0,column=4,padx=5)

       stayhome=Label(search_frame,font=('times new roman', 30,'bold'),text='Wear a Mask',fg='red', bg='white') 
       stayhome.place(x=780,y=0,width=600,height=30)

       img_logo_mask=Image.open('images/mask_logo1.jpg')
    ...
    def add_data(self):
        if self.var_dep.get()==""or self.var_email.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='sresdn79@',database='mydatabase')
    ...
    def update_data(self):
        if self.var_dep.get()==""or self.var_email.get()=="":
            ...
            try:
                update=messagebox,messagebox.askyesno('Update','Are you sure update this employee data ')
                if update>0:
                    conn=mysql.connector.connect(host='localhost',username='root',password='sresdn79@',database='mydatabase')
                    my_cursor=conn.cursor()
